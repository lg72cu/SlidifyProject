...
```{r, echo=FALSE}
turnout<-0:300
density<-dbinom(turnout, size=300, prob=2/7)
plot(turnout, density, type="l", xlab="number of people", ylab="probabilty",main="Probability of turnout")
```
...
It turns out although OBA has 300 members, 95% of the time, at most `r CI` will show up. 
